...
import com.bcing.ui.activity.WishBookDetailActivity;
...
public class WishBookListAdapter extends RecyclerView.Adapter<WishBookListAdapter.ViewHolder> {
...
//    private List<ItemBookDetail> ItemBookList = new ArrayList<>();
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            summary = (TextView) view.findViewById(R.id.bookset_summary);
            bookImage = (ImageView) view.findViewById(R.id.bookset_image);

        }
    }

    public WishBookListAdapter(Context context, List<CrossBookData> ItemBookListadpter) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.wish_book_set_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.summary.setText(booklist.getSummary());
...
//                bookData.addAll((booklist) .getBooks());
                ...
                //书籍详情
                Intent intent = new Intent(UIUtils.getContext(), WishBookDetailActivity.class);
                intent.putExtras(b);
