 ...
 * File Name:MySetFragment
 * Describe：Application
 */

public class MySetFragment extends LazyFragment {
    // 标志fragment是否初始化完成
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (view == null) {
            ...
            KLog.e("TAG", "MySetFragment--onCreateView");
            isPrepared = true;
            initBookDetailData();
            initSwipe_refresh();
            lazyLoad();
    ...
    public void initBookDetailData() {
        ...
        query.addWhereEqualTo("crossuser",currentusername);
